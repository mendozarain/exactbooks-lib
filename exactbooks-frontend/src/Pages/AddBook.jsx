...
import {
  ...
  export default function AddBook() {
    ...
    const handleSubmit = async (event) =>{
      ...
      let res = await axios.post(axios.defaults.baseURL+'books/add/', form_data,configAxios)
      .then(response => {
        navigate("/");
      })
      .catch(error => {
    ...
    <Flex
      ...
      <Stack
        ...
        <FormControl id="title" isRequired isInvalid={formData.titleError}>
         ...
         <FormControl id="title" isRequired isInvalid={formData.statusError}>
          <FormLabel>Status</FormLabel>
            <Select name="status" onChange={handleChange} placeholder='Select option'>
        ...
        <FormControl isRequired isInvalid={formData.book_typeError}>
          ...
          <Select name="book_type" onChange={handleChange} placeholder='Select option'>
        ...
        <FormControl isRequired isInvalid={formData.locationError}>
          ...
          <Select name="location" onChange={handleChange} placeholder='Select option'>
